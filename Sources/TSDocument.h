...
// FIX RULER SCROLL
- (void)redrawLineNumbers:(id)sender;
// END FIX RULER SCROLL
...
- (void)showHideInvisibleCharacters:(id)sender;// added by Terada
...
- (void)okForPanel:(id)sender;  //needed?
- (void)cancelForPanel:(id)sender;  //needed?
- (void)showStatistics:(id)sender;
- (void)updateStatistics:(id)sender;
- (IBAction)doTemplate:(id)sender;
...
// - (void)okForRequest:(id)sender;
// - (void)okForPrintRequest:(id)sender;
- (void)chooseEncoding:(id)sender;
- (NSStringEncoding)encoding;
- (void)close;
- (void)setProjectFile:(id)sender;
- (void)doLine:(id)sender;
- (IBAction)doTag:(id)sender;
- (IBAction)chooseProgram:(id)sender;
...
- (void)changeShowFullPath:(id)sender; // added by Terada
- (void)fixAutoMenu;
...
// End Bauer
- (NSString *)readInputArg:(NSString *)fileLine atIndex:(NSUInteger)i homePath:(NSString *)home job:(NSString *)jobname;
